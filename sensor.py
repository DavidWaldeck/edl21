"""Support for EDL21 Smart Meters with auto reconnect."""
...
PLATFORM_SCHEMA = PLATFORM_SCHEMA.extend(
    {
        ...
        vol.Optional(CONF_TIMEOUT, default=0): cv.positive_int,
...
class EDL21:
    ...
    async def restart_after_not_getting_data(self, reconnect_timeout):
        while True:
            if self._time_last_data_received is None:
